 ...
 <div class="container-fluid">
    <div class="row page-title">
        <div class="col-md-12">
            ...
            <h4 class="mb-1 mt-0">New Orders</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">New Orders<a class="btn btn-info btn-xs float-right" href="{{ route('admin.order.create')}}">All Orders</a></h4>
                    <p class="sub-header">
