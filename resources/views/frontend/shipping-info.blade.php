                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <fieldset id="account">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <input type="text" name="fullname" value="" placeholder="@lang('messages.Name')" id="input-name" class="form-control" required/>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="input-payment-email">@lang('messages.Email') <span style="color: red">*</span></label>
                                                <input type="email" name="email" value="" placeholder="@lang('messages.Email')" id="input-payment-email" class="form-control" required/>
                                            </div>
                                            <div class="form-group required">
                                                <label class="control-label" for="input-payment-telephone">@lang('messages.Phone') <span style="color: red">*</span></label>
                                                <input type="tel" name="telephone" value="" placeholder="@lang('messages.Phone')" id="input-payment-telephone" class="form-control" required/>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="address" class="form-control" id="address" cols="30" rows="5" placeholder="@lang('messages.Address')" required></textarea>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    $.ajax({
                        ...
                        success:function(data) {
                            if(data){
                                $('#upzila').empty();
                                $('#upzila').focus;
                                $('#upzila').append('<option value="">-- Select upzila --</option>');
                                $.each(data, function(key, value){
