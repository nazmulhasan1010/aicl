    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="objective_text">
          <h3>@lang('messages.Dist-object')</h3>
          <ul class="dept_list">
            <li>@lang('messages.Dist-li-1')</li>
            <li>@lang('messages.Dist-li-2')</li>
            <li>@lang('messages.Dist-li-3')</li>
            <li>@lang('messages.Dist-li-4')</li>
            <li>@lang('messages.Dist-li-5')</li>
            <li>@lang('messages.Dist-li-6')</li>
          </ul>
        </div>
      </div>
    </div>
