...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset('frontend/assets/images/slider-1.webp')}}" class="d-block w-100 carousel_img" alt="...">
        <div class="carousel-caption  d-md-block">
          <h1 style="" class="animate__animated animate__fadeInLeft">এ্যাথারটন ইমব্রুস কোম্পানী লিমিটেড</h1>
      ...
      <div class="carousel-item">
        <img src="{{ asset('frontend/assets/images/slider-2.webp')}}" class="d-block w-100 carousel_img" alt="...">
        <div class="carousel-caption  d-md-block">
          <h1 class="covid_h1">“করোনা প্রতিরোধে সতর্কতা মূলক আচরণ”</h1>
          <p>
            <ul class="covid_list">
      ...
      <div class="carousel-item ">
        <img src="{{ asset('frontend/assets/images/slider-3.webp')}}" class="d-block w-100 carousel_img" alt="...">
  ...
  <div class="crops" style="padding: 0px 15px">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="crops_text ">
          <div class="h4 animate__animated animate__fadeInLeft mb-5">@lang('messages.Save-crop')</div>
   ...
   <div class="farmers" id="farmer_desktop">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 farmers-parallax-window parallax_img_width farmers_text_first" data-parallax="scroll" data-image-src="{{ asset('frontend/assets/images/farmer.webp')}}">

      </div>
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 farmers_text_two">
        <div class="farmers_text">
          <div class="h4 animate__animated animate__fadeInLeft mb-5">@lang('messages.Raise-farmer')</div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="farmers_service_text">
          <div class="h4  animate__animated animate__fadeInDown mb-5">@lang('messages.Farmer-service')</div>
