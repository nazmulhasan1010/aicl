                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <button type="submit" class="btn btn-info"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                        </svg></button>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('remove-item',$item->id)}}"  class="btn btn-danger">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5" class="text-right"><strong>@lang('messages.Grand-total'):</strong></td>
                                        <td class="text-right"><strong>@lang('messages.Tk') {{number_format(\Cart::getTotal(),2) }}</strong></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="button-group">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 ">
                                <a class="btn btn-info" href="{{ route('product-by-category',Session::get('first_category') )}}">@lang('messages.Continue-to-shopping')</a>
                            </div>
                            <div class="col-md-6 col-sm-12 ">
                                <a href="{{ route('user-check')}}" id="cart_item_btn" class="btn btn-info">@lang('messages.Order-now')</a>
                            </div>
                        </div>
                    </div>
                    @else
