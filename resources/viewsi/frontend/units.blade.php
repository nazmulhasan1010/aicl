        ...
        <div class="col-sm-12 col-md-10 col-lg-10 offset-1">
          <div class="row">
              <div class="col-sm-2 col-md-2 col-lg-2">
                <a href="#pesticides"  class="btn unit animate__animated animate__fadeInLeftBig animate__repeat-3 3">@lang('messages.Pesticides')</a>
                <img class="unit_top_icon animate__animated animate__fadeInLeft animate__repeat-3	3" src="{{ asset('frontend/assets/images/unit_icon/top_pesticides.svg')}}" alt="Pesticides">
              </div>
              <div class="col-sm-2 col-md-2 col-lg-2">
                <a href="#packaging" class="btn unit animate__animated animate__fadeInLeft animate__repeat-3	3">@lang('messages.Packaging')</a>
                <img class="unit_top_icon animate__animated animate__fadeInLeftBig animate__repeat-3	3" src="{{ asset('frontend/assets/images/unit_icon/top_packagin.svg')}}" alt="Packaging">
              </div>
              <div class="col-sm-2 col-md-2 col-lg-2">
                <a href="#seed" class="btn unit animate__animated animate__fadeInLeft animate__repeat-3	3">@lang('messages.Seed')</a>
                <img class="unit_top_icon animate__animated animate__fadeInRightBig animate__repeat-3	3" src="{{ asset('frontend/assets/images/unit_icon/top_seed.svg')}}" alt="Seed" >
              </div>
              <div class="col-sm-2 col-md-2 col-lg-2">
                <a href="#consumer" class="btn unit animate__animated animate__fadeInRight animate__repeat-3	3">@lang('messages.Consumer')</a>
                <img class="unit_top_icon animate__animated animate__fadeInRightBig animate__repeat-3	3" src="{{ asset('frontend/assets/images/unit_icon/top_consumer.svg')}}" alt="Consumer" >
              </div>
              <div class="col-sm-2 col-md-2 col-lg-2">
                <a href="#construction" class="btn unit animate__animated animate__fadeInRightBig animate__repeat-3	3">@lang('messages.Construction')</a>
                <img class="unit_top_icon animate__animated animate__fadeInRight animate__repeat-3	3" src="{{ asset('frontend/assets/images/unit_icon/top_construction.webp')}}" alt="" srcset="">
              </div>
