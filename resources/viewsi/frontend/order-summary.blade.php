                        ...
                        <div class="panel-body">
                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-left">@lang('messages.Quantity')</td>
                            ...
                            <div class="buttons">
                                <form action="submit-order" method="POST">
                                    @csrf
                                    {{-- <div class="pull-left">
                                        <a href="" class="btn btn-primary mb-3" >@lang('messages.Read-alert')</a>
                                    </div> --}}
                                    <div class="pull-right">
                                        <button class="btn btn-primary mb-3" type="submit">@lang('messages.Read-alert')</button>
                                    </div>
                                </form>
                            </div>
