    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg management-info">
                ...
                <button class="btn btn-info" id="show_bm_info" style="display:inline-block">Click for more</button>
                <button class="btn btn-info" id="hidden_bm_info" style="display:none">Hidden</button>
